...
<?php echo view('./partials/title-meta', array('title' => 'Data Peminjaman')); ?>
...
<?php echo view('partials/page-title', array('pagetitle' => 'Pages', 'title' => 'Data Peminjaman')); ?>

<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Data Peminjaman Barang</h4>
            ...
            <div class="card-body">
                <div class="row g-2">
                    <div class="col-lg-4">
                        ...
                        <select class="search" name="search" id="search"></select>
                    </div>
...
//     ajax: {
//         dataType: 'json',
//         url: "<?= base_url('kesekretariatan/ajaxSearch'); ?>",
//         delay: 500,
...
function datapeminjam() {
    $.ajax({
        url: "<?= base_url('kesekretariatan/getdatapeminjaman') ?>",
        dataType: "json",
...
$(document).ready(function() {
    ...
    $('.add').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= base_url('kesekretariatan/formtambah_peminjaman') ?>",
            dataType: "json",
