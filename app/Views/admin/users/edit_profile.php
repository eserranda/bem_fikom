                ...
                <div class="card-body collapse show" id="collapseexample1">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-2 text-muted">
                            Ukuran foto <span class="fw-bold">610x610</span> pixels
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="flex-shrink-0">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-2 text-muted">
                            Foto tidak menggunakan <span class="fw-bold">Filter</span>
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="flex-shrink-0">
                ...
                <div class="card-body p-4">
                    <div class="text-center">
                        ...
                        <div class="profile-user position-relative d-inline-block mx-auto mb-2">
                            <img src="<?php if (user()->user_image != "") { ?><?= base_url(); ?>/<?= user()->user_image; ?>?<?= user()->updated_at; ?><?php } else { ?><?= base_url(); ?>/assets/images/users/default.jpg"
                                <?php } ?>" class="rounded-circle avatar-xl img-thumbnail user-profile-image"
                            ...
                            <div class="avatar-xs p-0 rounded-circle profile-photo-edit tekan" name="your_id"
                                ...
                                <input type="hidden" class="form-control" name="username"
                                    value="<?= user()->username; ?>">
                                <input type="file" id="profile-img-file-input" name="foto"
                                ...
                                <div class="invalid-feedback errorFoto mt-4" style="width: 120px;">
                    ...
                    <div class="card-body p-4">
                        <div class="tab-content">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" class="form-control" id="id" name="id"
                                            placeholder="Enter your firstname" value="<?= $id; ?>">
                                        <input type="text" class="form-control" id="fullname" name="fullname"
                                            placeholder="Enter your firstname" value="<?= $fullname; ?>">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nickname" name="nickname"
                                            placeholder="Nama panggilan sehari-hari" value="<?= $nickname; ?>">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="stambuk" class="form-label">Stambuk <sup
                                                class="text-danger">*Hubungi pengurus untuk mengganti
                                                stambuk</sup></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir"
                                            value="<?= $tempat_lahir; ?>" placeholder="Tempat Lahir">
                                        ...
                                        <div class="mb-2 col-lg-12">
                                            <select class="form-select" id="gender" name="gender">
                                                ...
                                                <option value="Laki-laki"
                                                    <?php if ($gender == 'Laki-laki') echo "selected"; ?>>Laki-laki
                                                </option>
                                                <option value="Perempuan"
                                                    <?php if ($gender == 'Perempuan') echo "selected"; ?>>Perempuan
                                                </option>
                                            </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control phone" id="phone_number"
                                            name="phone_number" value="<?= $phone_number; ?>"
                                            placeholder="0811-1234-2233-7xxx">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nama_angkatan" name="nama_angkatan"
                                            value="<?= $nama_angkatan; ?>" placeholder="Nama Angkatan">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="tahun_masuk" name="tahun_masuk"
                                            value="<?= $tahun_masuk; ?>" placeholder="Tahun Masuk">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="address" name="address"
                                            placeholder="Alamat Lengkap" value="<?= $address; ?>" placeholder="Alamat">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 d-flex">
                            ...
                            <input type="text" class="form-control" id="facebook" name="facebook"
                                placeholder="Url Profil Facebook" value="<?= $facebook; ?>">
                        </div>
                        ...
                        <div class="d-flex">
                            ...
                            <input type="text" class="form-control" id="instagram" name="instagram"
                                placeholder="username" value="<?= $instagram; ?>">
