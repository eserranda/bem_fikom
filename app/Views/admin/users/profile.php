        ...
        <div class="row g-4">
            <div class="col-auto">
                <div class="avatar-xl">
                    <img src="<?php if (user()->user_image != "") { ?><?= base_url(); ?>/<?= user()->user_image; ?>?<?= user()->updated_at; ?><?php } else { ?><?= base_url(); ?>/assets/images/users/default.jpg"
                        <?php } ?>" alt="user-img" class="avatar-xl rounded" />
                </div>
            </div>
            ...
            <div class="col">
                <div class="p-0">
                    ...
                    <p class="text-white-75 mb-0"><?= user()->username; ?></p>
                    <p class="text-white-75 fw-bold mb-2"><?= user()->jabatan; ?></p>
                        ...
                        <div class="hstack text-white-50 gap-1">
                            ...
                            <div>
                                <a href="https://www.instagram.com/<?= user()->instagram; ?>" class="avatar-xs d-block"
                                    target="_blank">
                                    <span class="avatar-title rounded-circle fs-16 bg-soft-light text-danger">
                            ...
                            <div>
                                <a href="<?= user()->facebook; ?>" class="avatar-xs d-block">
                                    <span class="avatar-title rounded-circle fs-16 bg-soft-light text-info">
                            ...
                            <div>
                                <a href="https://www.tiktok.com/<?= user()->tiktok; ?>" class="avatar-xs d-block"
                                    target="_blank">
                                    <span class="avatar-title rounded-circle fs-16 bg-soft-light text-dark text-light">
                            ...
                            <div>
                                <a href="Https://wa.me/+62<?php $a = user()->phone_number;
                                    ...
                                    <span class="avatar-title rounded-circle fs-16 bg-soft-light text-success">
            ...
            <div>
                <div class="d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <a class="btn btn-success" onclick="setting('<?= user()->id ?>')"><i
...
function setting(id) {
    ...
    $.ajax({
        type: "post",
        url: "<?= base_url('/users/edit_profile') ?>",
        data: {
            id: id
        },
        cache: false,
