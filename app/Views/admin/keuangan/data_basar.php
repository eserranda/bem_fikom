...
<script>
function edit(id_basar) {
    $.ajax({
        type: "get",
        url: "<?= base_url('keuangan/edit_basar') ?>",
        data: {
            id_basar: id_basar
        },
        dataType: "json",
...
function hapus(id_basar) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "post",
                url: "<?= base_url('keuangan/hapus_basar') ?>",
                data: {
                    id_basar: id_basar
                },
                dataType: "json",
