    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalgridLabel">Tambah Data Iuran Pengurus</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <?= form_open('keuangan/save_iuran', ['class' => 'formadd']) ?>
                <?= csrf_field(); ?>
                <div class="row g-3">
                    ...
                    <div class="col-xxl-3 col-md-6 hutangg" style="display: none;">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" class="form-control" id="denda" name="denda" placeholder="Input Denda">
                        </div>
                    </div>
