...
<?php echo view('partials/page-title', array('pagetitle' => 'Keuangan', 'title' => 'Iuran Pengurus')); ?>

<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Iuran Pengurus</h4>
...
<script src="<?= base_url() ?>/assets/js/pluggins.js"></script>
<script src="<?= base_url() ?>/assets/js/app.js"></script> -->

<script>
function databasar() {
    $.ajax({
        url: "<?= base_url('keuangan/getdata_iuran') ?>",
        dataType: "json",
...
$(document).ready(function() {
    ...
    $('.add').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= base_url('keuangan/formtambah_iuran') ?>",
            dataType: "json",
            success: function(response) {
