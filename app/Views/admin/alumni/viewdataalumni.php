...
<?php echo view('./partials/title-meta', array('title' => 'Data Alumni')); ?>
<?= $this->endSection(); ?>
...
<?php echo view('partials/page-title', array('pagetitle' => 'Pages', 'title' => 'Data Alumni')); ?>

<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Data Alumni</h4>
...
function dataalumni() {
    $.ajax({
        url: "<?= base_url('alumni/getdataalumni') ?>",
        dataType: "json",
...
$(document).ready(function() {
    ...
    $('.add').click(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= base_url('alumni/formtambah') ?>",
            dataType: "json",
