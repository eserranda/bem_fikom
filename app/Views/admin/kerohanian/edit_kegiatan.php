    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header p-3 bg-soft-success">
                <h5 class="modal-title" id="myModalLabel">Edit Data Kegiatan Kerohanian</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
            </div>

            <?= form_open('kerohanian/update_kegiatan', ['class' => 'formupdate']) ?>
            <?= csrf_field(); ?>
                        ...
                        <div class="mb-2 col-lg-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="pengeluaran_kegiatan"
                                    id="pengeluaran_kegiatan" value="<?= $pengeluaran_kegiatan; ?>">
