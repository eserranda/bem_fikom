        ...
        <div class="card">
            <div class="card-body">
                <div class="p-3 text-center">
                    ...
                    <a href="javascript:void(0);" onclick="viewfoto('<?= $row->id ?>')">
                        <img src="" alt="display-picture" class="rounded-circle avatar-xl foto" ">
                    </a>
                    
                    <div class=" mt-3">
                        <h5 class="fs-20 profile-name">Tess</h5>
                        <p class="fs-12 m-1">Tesss</p>
                        <p class="text-muted profile-designation fw-bold">Tess</p>
                </div>
                <div class="hstack gap-2 justify-content-center mt-4">
                    <div class="avatar-xs">
                        <a href="javascript:void(0);"
