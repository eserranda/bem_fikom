    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header p-3 bg-soft-success">
                <h5 class="modal-title" id="myModalLabel">Edit Data Kegiatan Kaderisasi</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
            </div>

            <?= form_open('kaderisasi/update_kegiatan', ['class' => 'formupdate']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <!-- <div class="row mb-2">
                            <div class="mb-2 col-lg-12">
                                <label for="task-title-input" class="form-label">Tanggal Selesai</label>
                                <input type="date" class="form-control" id="tanggal_kegiatan" name="tanggal_kegiatan"
                                    value="">
                                <div class="invalid-feedback errortanggalkegiatan">
