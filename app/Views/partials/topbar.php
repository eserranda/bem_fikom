            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language py-2" data-lang="id"
                            title="Indonesia">
                            <img src="<?= base_url(); ?>/assets/images/flags/id.svg" alt="user-image"
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language py-2" data-lang="en"
                            title="English">
                            <img src="<?= base_url(); ?>/assets/images/flags/us.svg" alt="user-image"
                                class="me-2 rounded" height="18">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="<?php if (user()->user_image != "") { ?><?= base_url(); ?>/<?= user()->user_image; ?>?<?= user()->updated_at; ?><?php } else { ?><?= base_url(); ?>/assets/images/users/default.jpg"
                                <?php } ?>" alt="">
                            <span class="text-start ms-xl-2">
                                <span
                                    class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?= user()->fullname; ?></span>
                                <span
                                    class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text"><?= user()->username; ?></span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- <a class="dropdown-item" href="<?= base_url('admin/users/profile/') ?>"
                        ...
                        <a class="dropdown-item" href="<?= base_url('admin/users/setting/') ?>">
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.sukses) {
                ...
                // location.href = "<?= base_url(); ?>/admin/users/edit_profilee";
                // $('#setting').show();
                // location.reload();
